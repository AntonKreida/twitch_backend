  ...
  async deleteIsDeactivatedAccount() {
    ...
    for (const user of users) {
      await this.emailService.sendEmail({
        ...
        message:
          'Ваш аккаунт был удален из-за неактивности в течение 7 дней. Спасибо что были с нам! Если вы хотите восстановить свой аккаунт, пожалуйста зарегистрируйтесь заново по нажатию на кнопку ниже.',
